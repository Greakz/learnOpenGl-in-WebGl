...
export class Shader {
    ...
    public uniform_locations: {
        ...
        point_shadow_map: WebGLUniformLocation;
        point_shadow_far_plane: WebGLUniformLocation;
    ...
    create() {
        ...
        this.uniform_locations = {
            ...
            point_shadow_map: GL.getUniformLocation(this.program, 'point_shadow_map'),
            point_shadow_far_plane: GL.getUniformLocation(this.program, 'point_shadow_far_plane'),
